...
class SharingHeaders extends Component {
  ...
  render () {
    ...
    const meta = [
      ...
      { property: 'og:image:height', content: 360 || video.poster.dimension.height },
      { property: 'og:image:secure_url', content: 'https://images.tijd.be/view?iid=dc:75802376&context=ONLINE&ratio=16/9&width=640&imageType=JPEG&ts=1486562420000' || location.origin + video.poster.url },
      { property: 'og:image:type', content: 'image/jpeg' },
      { property: 'og:image:width', content: 640 || video.poster.dimension.width },
      { property: 'og:image', content: 'https://images.tijd.be/view?iid=dc:75802376&context=ONLINE&ratio=16/9&width=640&imageType=JPEG&ts=1486562420000' || location.origin.replace('https', 'http') + video.poster.url },

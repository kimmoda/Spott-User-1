...
class SharingHeaders extends Component {
  ...
  render () {
    ...
    const meta = [
      ...
      { property: 'og:image:secure_url', content: 'https://s3-eu-west-1.amazonaws.com/appiness-spott-tst/public/images/trailer-1-poster.jpg' || location.origin + video.poster.url },
      { property: 'og:image:type', content: 'image/jpeg' },
      { property: 'og:image:width', content: video.poster.dimension.width },
      { property: 'og:image', content: 'https://s3-eu-west-1.amazonaws.com/appiness-spott-tst/public/images/trailer-1-poster.jpg' || location.origin.replace('https', 'http') + video.poster.url },

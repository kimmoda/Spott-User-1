...
import { productImpression } from '../../data/actions';
import { connect } from 'react-redux';
import { bindActionCreators } from 'redux';

@connect(null, (dispatch) => ({
  productImpression: bindActionCreators(productImpression, dispatch)
}))
export default class ProductImpressionSensor extends Component {
  ...
  handleVisibilitySensor (isVisible) {
    if (isVisible && this.props.productId) {
      ...
      this.props.productImpression({ productId: this.props.productId });
    }
  }

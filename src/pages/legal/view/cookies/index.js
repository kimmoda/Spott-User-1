    ...
    return (
      <LegalPages history={history} location={location}>
        <section styleName='content'>
          <div dangerouslySetInnerHTML={{ __html: this.props.getLocalizedResource('cookies') }}/>
        </section>
        <SEOWidget description={t('seo.cookie.description')} title={`${t('seo.title')} - ${t('seo.cookie.title')}`}/>
      </LegalPages>
    );
  }
}

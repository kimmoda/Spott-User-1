...
export const RESET_USER_FOLLOWERS_COUNTER_START = 'NEW/RESET_USER_FOLLOWERS_COUNTER_START';
export const RESET_USER_FOLLOWERS_COUNTER_SUCCESS = 'NEW/RESET_USER_FOLLOWERS_COUNTER_SUCCESS';
export const RESET_USER_FOLLOWERS_COUNTER_ERROR = 'NEW/RESET_USER_FOLLOWERS_COUNTER_ERROR';
...
export const RESET_USER_ACTIVITY_FEED_COUNTER_START = 'NEW/RESET_USER_ACTIVITY_FEED_COUNTER_START';
export const RESET_USER_ACTIVITY_FEED_COUNTER_SUCCESS = 'NEW/RESET_USER_ACTIVITY_FEED_COUNTER_SUCCESS';
export const RESET_USER_ACTIVITY_FEED_COUNTER_ERROR = 'NEW/RESET_USER_ACTIVITY_FEED_COUNTER_ERROR';
...
export const TRACK_SPOTT_IMPRESSION_START = 'NEW/TRACK_SPOTT_IMPRESSION_START';
export const TRACK_SPOTT_IMPRESSION_SUCCESS = 'NEW/TRACK_SPOTT_IMPRESSION_SUCCESS';
export const TRACK_SPOTT_IMPRESSION_ERROR = 'NEW/TRACK_SPOTT_IMPRESSION_ERROR';
...
export const APPBOY_LOAD_START = 'NEW/APPBOY_LOAD_START';
export const APPBOY_LOAD_SUCCESS = 'NEW/APPBOY_LOAD_SUCCESS';
export const APPBOY_LOAD_ERROR = 'NEW/APPBOY_LOAD_ERROR';

export const APPBOY_FEED_OPEN = 'NEW/APPBOY_FEED_OPEN';
export const APPBOY_FEED_CLOSE = 'NEW/APPBOY_FEED_CLOSE';
// Actions creators
// ////////////////
...
export const trackSpottImpression = makeApiActionCreator(api.trackSpottImpression, TRACK_SPOTT_IMPRESSION_START, TRACK_SPOTT_IMPRESSION_SUCCESS, TRACK_SPOTT_IMPRESSION_ERROR);
...
export const resetUserFollowersCounter = makeApiActionCreator(api.resetUserFollowersCounter, RESET_USER_FOLLOWERS_COUNTER_START, RESET_USER_FOLLOWERS_COUNTER_SUCCESS, RESET_USER_FOLLOWERS_COUNTER_ERROR);
...
export const resetUserActivityFeedCounter = makeApiActionCreator(api.resetUserActivityFeedCounter, RESET_USER_ACTIVITY_FEED_COUNTER_START, RESET_USER_ACTIVITY_FEED_COUNTER_SUCCESS, RESET_USER_ACTIVITY_FEED_COUNTER_ERROR);

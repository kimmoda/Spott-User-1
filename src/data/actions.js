...
export const SCENES_FOR_YOU_FETCH_START = 'DATA/SCENES_FOR_YOU_FETCH_START';
export const SCENES_FOR_YOU_FETCH_SUCCESS = 'DATA/SCENES_FOR_YOU_FETCH_SUCCESS';
export const SCENES_FOR_YOU_FETCH_ERROR = 'DATA/SCENES_FOR_YOU_FETCH_ERROR';
...
export const fetchScenesForYou = makeApiActionCreator(scenesApi.getScenesForYou, SCENES_FOR_YOU_FETCH_START, SCENES_FOR_YOU_FETCH_SUCCESS, SCENES_FOR_YOU_FETCH_ERROR);
